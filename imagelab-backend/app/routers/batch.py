...
async def create_batch_job(
    ...
    pipeline: Annotated[str, Form(description="JSON string representing a list of PipelineStep")],
    ...
    try:
        pipeline_steps = TypeAdapter(list[PipelineStep]).validate_json(pipeline)
    ...
    background_tasks.add_task(run_batch_job, job_id, filenames, pipeline_steps, image_format)
