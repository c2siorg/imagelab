...
export const operatorDocs: Record<string, OperatorDoc> = {
    ...
    "geometric_rotateimage": {
        ...
        name: "Rotate Image",
        description: "Rotates the image by a specified angle around a chosen center point using an affine transformation.",
        parameters: [
    ...
    "geometric_affineimage": {
        ...
        parameters: [
            { name: "Points", description: "Three points in the original image mapped to three points in the output." }
        ],
    ...
    "geometric_scaleimage": {
        ...
        parameters: [
            { name: "Scale X, Scale Y", description: "Scaling factors along the horizontal and vertical axes." }
        ],
    ...
    "imageconvertions_grayimage": {
        ...
        description: "Converts a multi-channel RGB/BGR image into a single-channel grayscale image. Uses the standard weighted luminosity method.",
        parameters: [],
        formula: "Y = 0.299*R + 0.587*G + 0.114*B",
        useCases: ["Removing color noise, decreasing computational load, preparing for edge detection."]
    },
    ...
    "imageconvertions_graytobinary": {
        ...
        name: "Gray to Binary",
        description: "Applies a threshold to turn a grayscale image into a pure black and white (binary) image.",
        parameters: [
            { name: "Threshold Value", description: "Pixel values above this threshold become maximal (255), otherwise 0." }
        ],
    ...
    "imageconvertions_colormaps": {
        ...
        name: "Color Maps",
        description: "Applies a pseudo-color map to a grayscale image to enhance visual perception of intensity.",
        parameters: [
    ...
    "imageconvertions_colortobinary": {
        ...
        description: "Directly converts a color image to a binary mask using predefined threshold configurations.",
        parameters: [
    ...
    "drawingoperations_drawarrowline": {
        ...
        parameters: [
            { name: "Start/End Points", description: "Tail and head of the arrow." }
        ],
    ...
    "blurring_applyblur": {
        ...
        name: "Simple Blur",
        description: "Smoothes an image using a normalized box filter. Replaces each pixel with the average of its neighbors.",
        parameters: [
            { name: "Kernel Size (KSize)", description: "Size of the averaging box." }
        ],
    ...
    "blurring_applygaussianblur": {
        ...
        name: "Gaussian Blur",
        description: "Blurs an image using a Gaussian filter. Highly effective at removing Gaussian noise from the image.",
        parameters: [
    ...
    "blurring_applymedianblur": {
        ...
        name: "Median Blur",
        description: "Replaces each pixel's value with the median of its neighboring pixels. Highly effective against salt-and-pepper noise.",
        parameters: [
    ...
    "filtering_sharpen": {
        ...
        name: "Sharpen",
        description: "Enhances edges and high-frequency detail in an image using a custom convolution kernel.",
        parameters: [
            { name: "Intensity", description: "Strength of the sharpening effect." }
        ],
    ...
    "filtering_pyramidup": {
        ...
        name: "Pyramid Up",
        description: "Upsamples an image by injecting even zero rows/cols and applying a Gaussian filter.",
        parameters: [],
    ...
    "filtering_boxfilter": {
        ...
        name: "Box Filter",
        description: "Blurs an image using a box filter convolution. Similar to normalized blur but can be unnormalized.",
        parameters: [
    ...
    "filtering_erosion": {
        ...
        name: "Erosion",
        description: "Erodes away the boundaries of foreground object. The pixel in the original image will be considered 1 only if all the pixels under the kernel is 1.",
        parameters: [
            { name: "Iterations", description: "Number of times erosion is applied." }
        ],
    ...
    "filtering_dilation": {
        ...
        name: "Dilation",
        description: "Increases the white region in the image or size of foreground object. Opposite of erosion.",
        parameters: [
            { name: "Iterations", description: "Number of times dilation is applied." }
        ],
    ...
    "filtering_morphological": {
        ...
        description: "Advanced morphological operations like Opening (erosion followed by dilation) and Closing (dilation followed by erosion).",
        parameters: [
    ...
    "thresholding_adaptivethreshold": {
        ...
        description: "Calculates the threshold for small regions of the image, getting better results for varying lighting conditions.",
        parameters: [
    ...
    "thresholding_applyborders": {
        ...
        parameters: [
            { name: "Border Type", description: "Constant, Replicate, Reflect, Wrap." }
        ],
    ...
    "border_each_side": {
        ...
        description: "Applies variable border thickness independently to top, bottom, left, and right sides.",
        parameters: [
            { name: "T/B/L/R", description: "Individual side padding amounts." }
        ],
    ...
    "thresholding_otsuthreshold": {
        ...
        description: "Automatically calculates an optimal threshold value by analyzing the image histogram to minimize intra-class variance.",
        parameters: [],
        useCases: ["Bimodal images where foreground and background pixel distributions are well separated."]
    },
    ...
    "sobelderivatives_scharrderivate": {
        ...
        description: "Calculates the first spatial image derivative using the Scharr filter instead of Sobel for better rotational symmetry.",
        parameters: [
            { name: "DX, DY", description: "Order of the derivative in x and y (only one can be 1, the other 0)." }
        ],
    ...
    "transformation_laplacian": {
        ...
        description: "Calculates the Laplacian of an image, highlighting regions of rapid intensity change.",
        parameters: [
            { name: "KSize", description: "Aperture size used to compute the second-derivative filters." }
        ],
        formula: "Δf = ∂²f/∂x² + ∂²f/∂y²",
